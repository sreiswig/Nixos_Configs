...
| incus_cloud | `incus_cloud` | `incus-cloud` (TBD MagicDNS) | NixOS | _TBD — stub hardware_ | Incus personal-cloud daemon | Slice A placeholder; **not** AIServer. Fill hardware before switch. See [incus-personal-cloud.md](./incus-personal-cloud.md). |
...
is up; ethernet + OOB KVM for radio / NIC death). Shopping / upgrade shortlist:
[home-network-upgrade.md](./home-network-upgrade.md).
